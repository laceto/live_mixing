...
if __name__ == "__main__":
    ...
    setlist = export_setlist_csv(
        "setlist_2026-08-15.csv", start="2026-08-15T14:57", end="2026-08-15T17:13"
    )
    print(setlist)

    all_tracks = export_tracks_csv("tracks_export.csv")
    print(all_tracks.shape)

    all_playlists = export_playlists_csv("playlists_export.csv")
    ...
    sessions_csv = export_sessions_csv("sessions_export.csv")
    print(sessions_csv.shape)

    session_setlist = export_session_setlist_csv(90)
